    ...
    >
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 xs:mb-4 md:mb-6 leading-tight">
            ...
            <div className="flex flex-col xs:flex-row space-y-3 xs:space-y-0 xs:space-x-4">
              <Link
                href="#portfolio"
                className="bg-gradient-primary hover:opacity-90 transition-opacity text-white px-5 xs:px-6 py-4 xs:py-5 md:px-8 md:py-6 rounded-full font-medium text-sm sm:text-base text-center"
              >
                Ver Portfólio
              </Link>
              <Link
                href="#servicos"
                className="border border-border hover:border-primary text-white px-5 xs:px-6 py-4 xs:py-5 md:px-8 md:py-6 rounded-full font-medium text-sm sm:text-base text-center"
              >
                Nossos Serviços
              </Link>
            </div>
